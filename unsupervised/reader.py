...
if __name__ == '__main__':
    conver2npy_image('/home/give/PycharmProjects/Reproduce/CenterLoss/unsupervised/data/t10k-images-idx3-ubyte',
                     '/home/give/PycharmProjects/Reproduce/CenterLoss/unsupervised/data/test_images.npy')
    conver2npy_image('/home/give/PycharmProjects/Reproduce/CenterLoss/unsupervised/data/train-images-idx3-ubyte',
                     '/home/give/PycharmProjects/Reproduce/CenterLoss/unsupervised/data/train_images.npy')
    convert2npy_label('/home/give/PycharmProjects/Reproduce/CenterLoss/unsupervised/data/t10k-labels-idx1-ubyte',
                      '/home/give/PycharmProjects/Reproduce/CenterLoss/unsupervised/data/test_labels.npy')
    convert2npy_label('/home/give/PycharmProjects/Reproduce/CenterLoss/unsupervised/data/train-labels-idx1-ubyte',
                      '/home/give/PycharmProjects/Reproduce/CenterLoss/unsupervised/data/train_labels.npy')
    reader = Reader('/home/give/PycharmProjects/Reproduce/CenterLoss/unsupervised/data')
    for (image_batch, label_batch) in reader.test_generator:
        image_batch = np.array(image_batch)
        print np.shape(image_batch), np.shape(label_batch)
        from PIL import Image
        img = Image.fromarray(np.asarray(image_batch[0, :, :, :] * 255).squeeze())
        print label_batch[0]
